...
export default function ViraTerms() {
  useEffect(() => {
    document.title = "VIRA - Terms of Service | Sugara Tech";
    window.scrollTo(0, 0);
  }, []);
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <article className="prose prose-invert max-w-none space-y-8 text-slate-300 leading-relaxed">
          <section className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800">
            <p>
              Welcome to <strong>VIRA</strong>, an AI-powered virtual assistant operated by <strong>Sugara Tech</strong>.
            </p>
            <p className="mt-3">
          ...
          <section id="section-5" className="space-y-3">
            ...
            <p>
              All software, source code, trademarks, logos, designs, and related intellectual property associated with VIRA remain the property of Sugara Tech unless otherwise stated.
            </p>
            <p>
          ...
          <section id="section-7" className="space-y-3">
            ...
            <p>
              To the maximum extent permitted by law, Sugara Tech shall not be liable for indirect, incidental, special, or consequential damages arising from the use of VIRA.
            </p>
            <p>
